...
.statement-box {
    ...
    padding: 1.2rem 1.4rem; border-radius: 4px; font-family: 'IBM Plex Mono', monospace;
    font-size: 0.82rem; color: #0d1b2e; line-height: 1.8; margin: 0.5rem 0;
}
...
/* CB source links */
.cb-links { display: flex; flex-wrap: wrap; gap: 0.6rem; margin-top: 0.8rem; }
.cb-link {
...
.cb-link:hover { background: #0d3b7a; color: white; }
...
def plain_english(score):
    if score > 30:
        ...
        return "Leaning toward tighter policy. Expect rates to stay elevated — no immediate hike, but the bank is watching inflation closely."
    elif score > -10:
        return "On hold. The bank is watching incoming data before committing to a move in either direction."
    elif score > -30:
...
statements = {
    ...
    "ECB": [
        ...
        {"date":"2025-04","text":"The Governing Council decided to lower the three key ECB interest rates by 25 basis points. Disinflation is proceeding well. Staff project that inflation will fluctuate around the current level in the near term. The policy stance is becoming meaningfully less restrictive."},
    ],
    "RBI": [
        {"date":"2022-05","text":"The Monetary Policy Committee decided unanimously to increase the policy repo rate by 40 basis points to 4.4%. Inflation has risen sharply and is ruling above the upper tolerance band of 6%. The MPC judged that the risks to inflation are on the upside. Anchoring of inflation expectations is the need of the hour."},
...
BG='#faf8f4'; BG2='#f0ece4'; NAVY='#0d3b7a'; DARK='#0d1b2e'
MUTED='#5a6a7a'; GRID='#d8d4cc'
CB_COLOURS = {'Fed':'#1e5fb4','BoE':'#c0392b','MAS':'#1a6b3c','ECB':'#e67e22','RBI':'#8a6e00'}

# ── MASTHEAD ──────────────────────────────────────────────────────────────────
st.markdown("""
<div class='masthead'>
  <div class='masthead-eyebrow'>GOKHALE MACRO RESEARCH · NLP ANALYSIS · 2026</div>
...
# ── SECTION 03: WHAT DO SCORES MEAN ──────────────────────────────────────────
...
The central bank is in <b>wait and see</b> mode. Policy is on hold, watching incoming data. Neither hiking nor cutting is imminent. MAS sat here through 2023–2024 after its aggressive 2022 tightening cycle — doing the work passively without further adjustments.
</div>""", unsafe_allow_html=True)
with col3:
    st.markdown("""<div class='dcp-box'>
...
# Source links
st.markdown("""
<p style='font-family:IBM Plex Mono,monospace;font-size:0.72rem;color:#3a4a5a;margin-bottom:0.6rem;'>
...
with col1:
    ...
    cb_name = st.text_input("Central bank / label (optional)", placeholder="e.g. Fed, BoE, MAS, ECB, RBI...")
